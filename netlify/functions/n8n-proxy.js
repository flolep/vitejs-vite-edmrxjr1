...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const allowedEndpoints = [
      ...
      'blindtest-quiz-mode',        // 🎯 Endpoint pour le mode Quiz (v3.0.x - déprécié)
      'blindtest-batch-playlist',   // 🆕 Endpoint pour génération groupée (mode Équipe + Quiz)
      'blindtest-wrong-answers'     // 🎲 Endpoint pour génération des mauvaises réponses (mode Quiz v4.0)
    ];
