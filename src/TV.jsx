...
export default function TV() {
  ...
  // Écouter le numéro de track actuel (pour le mode quiz)
  useEffect(() => {
    if (!sessionValid || !sessionId) return;
    const currentTrackRef = ref(database, `sessions/${sessionId}/currentTrack`);
    const unsubscribe = onValue(currentTrackRef, (snapshot) => {
